...
foreign import ccall unsafe "dGeomCCylinderGetParams"   c'dGeomCCylinderGetParams   :: Geom -> Float -> Float -> IO ()
foreign import ccall unsafe "dGeomRaySet"               c'dGeomRaySet               :: Geom -> Float -> Float -> Float -> Float -> Float -> Float -> IO ()
foreign import ccall unsafe "dGeomRayGet"               c'dGeomRayGet               :: Geom -> Ptr a -> Ptr b -> IO (Ptr c)
